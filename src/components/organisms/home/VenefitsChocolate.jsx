...
const benefits = [
  {
    ...
    title: "Más placer",
    text: "Despierta emociones y eleva tu ánimo, convirtiendo cada momento en una experiencia única.",
  },

  {
    ...
    text: "Para acompañar cada momento de tu día con la mejor actitud y bienestar.",
  },
  {
    num: "03",
    image: "/benefit_antioxidants.webp",
    title: "Antioxidantes naturales",
    text: "Sustancias que ayudan a cuidar las células, retrasan el envejecimiento y mantienen tu cuerpo sano.",
  },
  {
    num: "04",
    image: "/benefit_details.webp",
    title: "Detalles que enamoran",
    text: "Shilibombones, shilicotejas y chocolate al 70% cacao, delicias pensadas para disfrutar y compartir.",
  },
  {
    num: "05",
    image: "/benefit_moments.webp",
    title: "Momentos únicos",
    text: "Nuestro chocolate reúne a la familia en momentos de alegría compartida, y cuando lo disfrutas a solas, despierta la magia de esos recuerdos que siempre te acompañan.",
  },
];
