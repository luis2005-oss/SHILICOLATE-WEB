  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          borderTop: `1.5px solid ${GOLD}99`,
          borderLeft: `1.5px solid ${GOLD}99`,
        }}
      />
      <span
        className="absolute bottom-0 right-0 w-7 h-7 pointer-events-none"
        style={{
          borderBottom: `1.5px solid ${GOLD}99`,
          borderRight: `1.5px solid ${GOLD}99`,
        }}
      />
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden flex flex-col items-center justify-center pt-28 pb-20 px-4">
      <div className="absolute inset-0 z-0">
        ...
        {/* Overlay oscuro */}
        <div className="absolute inset-0 bg-[rgba(11,3,0,0.7)]" />
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col items-center gap-14">
        ...
        >
          ...
          <div className="flex items-center gap-3 w-40">
            ...
            />
            <div
              className="w-1.5 h-1.5 flex-shrink-0 bg-[#d4af37]"
              style={{ transform: "rotate(45deg)" }}
            />
            <div
              className="flex-1 h-px opacity-70"
              style={{
                background: `linear-gradient(to left, ${GOLD}, #c8895a)`,
              }}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-6 items-center w-full">
          ...
          >
            <InfoCard
              title="Misión"
              text={mision}
              tags="Artesanal · Sostenible"
            />
          </div>

          <div
            className="flex flex-col items-center gap-3 order-first md:order-none"
            data-aos="zoom-in"
          ...
          >
            ...
            />
            <div
              className="w-1.5 h-1.5 bg-[#d4af37] opacity-70"
              style={{ transform: "rotate(45deg)" }}
            />
            <div
              className="w-px h-8"
