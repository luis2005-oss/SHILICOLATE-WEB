...
function ContactHero() {
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="
            absolute inset-0
            bg-gradient-to-b
            from-[rgba(26,13,8,0.7)]
            via-[rgba(26,13,8,0.45)]
            to-[rgba(26,13,8,0.75)]
          "
          style={{
            backdropFilter: "sepia(25%) brightness(0.38)",
          }}
        />
      </div>
      ...
      <div
        className="
          absolute left-10 top-[20%] bottom-[25%]
          w-px z-10 opacity-20
        "
        style={{
      ...
      <div
        className="
          absolute right-10 top-[20%] bottom-[25%]
          w-px z-10 opacity-20
        "
        style={{
          background: `linear-gradient(to bottom, transparent, ${GOLD}, transparent)`,
      ...
      >
        ...
        >
          ...
          Estamos aquí para escucharte y hacer de tu
