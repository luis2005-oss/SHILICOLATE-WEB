...
const products = [
  ...
  { idProduct: 25, name: "Shilicoteja de Maracuyá",     category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de maracuyá, equilibrio perfecto entre dulzura y acidez." },
  { idProduct: 26, name: "Shilicoteja de Maracumago",   category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Con mermelada de maracuyá y mango, una mezcla tropical de dulzura y frescura." },
  { idProduct: 27, name: "Shilicoteja de Naranja",      category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Con mermelada de naranja, una combinación cítrica de dulzura y acidez." },
  { idProduct: 28, name: "Shilicoteja de Mandarina",    category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de mandarina, con un toque cítrico en cada bocado." },
  { idProduct: 29, name: "Shilicoteja de Aguaymanto",   category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de aguaymanto, con un ligero toque agridulce." },
  { idProduct: 30, name: "Shilicoteja de Piña",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de piña, con un sabor tropical y refrescante." },
  { idProduct: 31, name: "Shilicoteja de Limón",        category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de limón, con un toque cítrico y refrescante." },
  { idProduct: 32, name: "Shilicoteja de Tamarindo",    category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de tamarindo, con un sabor único y refrescante." },
  { idProduct: 33, name: "Shilicoteja de Pisco",        category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con crema de pisco, un delicado toque de licor que resalta el cacao." },
  { idProduct: 34, name: "Shilicoteja de Vino",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con vino, un toque de licor que resalta el sabor del chocolate." },
  { idProduct: 35, name: "Shilicoteja de Fresa",        category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de fresa, con un sabor dulce y refrescante." },
  { idProduct: 36, name: "Shilicoteja de Mora",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de mora, con un sabor intenso y refrescante." },
  { idProduct: 37, name: "Shilicoteja de Arándano",     category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de arándano, con un sabor dulce y refrescante." },
  { idProduct: 38, name: "Shilicoteja de Sauco",        category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de sauco, con un sabor único y refrescante." },
  { idProduct: 39, name: "Shilicoteja de Lúcuma",       category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con crema de lúcuma, un sabor suave que endulza cada bocado." },
  { idProduct: 40, name: "Shilicoteja de Pasas",        category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con pasas deshidratadas, un sabor dulce que endulza cada bocado." },
  { idProduct: 41, name: "Shilicoteja de Guindón",      category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de guindón, con un sabor intenso y refrescante." },
  { idProduct: 42, name: "Shilicoteja de Café",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de café, con un sabor intenso y refrescante." },
  { idProduct: 43, name: "Shilicoteja de Pitahaya",     category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de pitahaya, con un sabor único y refrescante." },
  { idProduct: 44, name: "Shilicoteja de Pecana",       category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de pecana, con un sabor intenso y refrescante." },
  { idProduct: 45, name: "Shilicoteja de Coco",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de coco, con un sabor tropical y refrescante." },
  { idProduct: 46, name: "Shilicoteja de Maní",         category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de maní, con un sabor intenso y refrescante." },
  { idProduct: 47, name: "Shilicoteja de Almendra",     category: "Shilicotejas",         price: 1,   URL: "/SHILICOTEJAS.png",            desc: "Rellena con mermelada de almendra, con un sabor intenso y refrescante." },
]
