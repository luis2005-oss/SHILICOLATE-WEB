...
const products = [  
  ...
  { idProduct: 15, name: "Sabor a Pecana de 70gr",      category: "Chocolate comestible", flavor: "Pecana", price: 8,   URL: "/CHOCOLARE-COM-PECANA.png",     desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 16, name: "Sabor a Blueberry de 70gr",   category: "Chocolate comestible", flavor: "Blueberry", price: 8,   URL: "/CHOCOLARE-COM-BLUEBERRY.png",  desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 17, name: "Sabor Aguaymanto de 70gr",    category: "Chocolate comestible", flavor: "Aguaymanto", price: 8,   URL: "/CHOCOLARE-COM-AGUAYMANTO.png", desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 18, name: "Sabor a Cafe de 70gr",        category: "Chocolate comestible", flavor: "Cafe", price: 8,   URL: "/CHOCOLARE-COM-CAFE.png",       desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 19, name: "Sabor a Almendra de 70gr",    category: "Chocolate comestible", flavor: "Almendra", price: 8,   URL: "/CHOCOLARE-COM-ALMENDRA.png",   desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 20, name: "Sabor a Pecana de 35gr",      category: "Chocolate comestible", flavor: "Pecana", price: 4,   URL: "/CHOCOLARE-COM-PECANA.png",     desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 21, name: "Sabor a Blueberry de 35gr",   category: "Chocolate comestible", flavor: "Blueberry", price: 4,   URL: "/CHOCOLARE-COM-BLUEBERRY.png",  desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 22, name: "Sabor Aguaymanto de 35gr",    category: "Chocolate comestible", flavor: "Aguaymanto", price: 4,   URL: "/CHOCOLARE-COM-AGUAYMANTO.png", desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 23, name: "Sabor a Cafe de 35gr",        category: "Chocolate comestible", flavor: "Cafe", price: 4,   URL: "/CHOCOLARE-COM-CAFE.png",       desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  { idProduct: 24, name: "Sabor a Almendra de 35gr",    category: "Chocolate comestible", flavor: "Almendra", price: 4,   URL: "/CHOCOLARE-COM-ALMENDRA.png",   desc: "Chocolate comestible artesanal con deliciosos sabores naturales." },
  ...
  { idProduct: 42, name: "Shilicoteja de Café",         category: "Shilicotejas", flavor: "Café", price: 1,   URL: "/SHILICOTEJA-CAFE.png",            desc: "Rellena con mermelada de mango, con un sabor tropical y refrescante." },
